      ...
      {showForm && (
        <div className="absolute inset-0 bg-black bg-opacity-80 flex justify-center items-center">
          ...
          >
            ...
            <p>Hybrid sports- a better Place to Showcase Academies</p>

            <label className="block mb-2">Name of the Academy:</label>
            <input type="text" className="bg-black border p-2 mb-4 w-full" required />

            <label className="block mb-2">Type of Sports:</label>
            <input type="text" className="bg-black border p-2 mb-4 w-full" required />
