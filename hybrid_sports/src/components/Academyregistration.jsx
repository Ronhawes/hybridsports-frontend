...
const Academyregistration = ({ additionalClasses = "" }) => {
        ...
        <div className="fixed inset-0 bg-black bg-opacity-80 flex justify-center items-center z-50">
          <div className="bg-transparent p-5 rounded shadow-md w-full max-w-lg mx-4 mt-8 max-h-[80vh] overflow-y-auto">
            ...
            >
              ...
              <label className="mt-4 text-white p-2 rounded">*Parent/guardian Phone No:</label>
              <input 
                type="tel" 
                name="phoneNo" 
              ...
              <label className="mt-4 text-white p-2 rounded">*Parent/guardian Email:</label>
              <input 
                type="email" 
                name="email" 
